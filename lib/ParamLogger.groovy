...
class ParamLogger {
    ...
    public static LinkedHashMap paramsSummaryMap(workflow, params) {
        ...
        if (params.runFolder) {
            ...
            exec_opts['bclConvertParams'] = params.bclConvertParams
        }
        if (params.reporting) {
            workflow_opts['reporting'] = params.reporting
            workflow_opts['resultDir'] = params.resultDir
        }
        if (params.bam1Dir) {
            workflow_opts['bam1Dir'] = params.bam1Dir
            workflow_opts['bam2Dir'] = params.bam2Dir
            exec_opts['bamRgHeader'] = params.bamRgHeader
        }
        ...
        exec_opts['splitBarcodeParsing'] = params.splitBarcodeParsing
        exec_opts['adapters'] = params.adapters
        exec_opts['minUniqTotal'] = params.minUniqTotal
        exec_opts['maxUniqTotal'] = params.maxUniqTotal
        exec_opts['max_memory'] = params.max_memory
        exec_opts['max_cpus'] = params.max_cpus
