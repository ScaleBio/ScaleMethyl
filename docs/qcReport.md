...
**Percent Reads in Passing Cells(%)**: The percent of total reads in passing cell barcodes\
**Median Unique Reads**: The median number of unique reads per passing cell barcode\
**Median CG's Covered**: The median number of covered cytosines in the CG context per passing cell barcode\
**Median CH's Covered**: The median number of covered cytosines in the CH context per passing cell barcode\
**Median CG Methylation Percent**: The median percentage of covered cytosines in the CG context\
**Median CH Methylation Percent**: The median percentage of covered cytosines in the CH context\
**Median TSS Enrichment**: The median score of transcription start site enrichment for all passing cell barcodes\
